...
import os #,sys
from PyQt5.QtWidgets import QWidget, QVBoxLayout,QHBoxLayout, QPushButton, QFileDialog, QSpinBox, QLabel, QMessageBox, QComboBox #,QApplication
...
#|__] |  \ |  | |    |  | | |___ |  | |___    |__| ___] |___ |  \    | | \|  |  |___ |  \ |    |  | |___ |___ 
    ...
    def GUI(self):
        ...
        self.pixel_size_spinbox.setToolTip("Pixel size")
        ...
        # Create a QHBoxLayout for the pixel size label and spinbox
        self.HLayPixelSize = QHBoxLayout()
        self.HLayPixelSize.addWidget(QLabel("Pixel Size"))
        self.HLayPixelSize.addWidget(self.pixel_size_spinbox)

        # Add the QHBoxLayout to the QVBoxLayout
        self.VLayPixel.addLayout(self.HLayPixelSize)
