...
from PyQt5.QtWidgets import  QWidget, QVBoxLayout, QPushButton, QFileDialog, QSlider, QProgressBar, QCheckBox, QMessageBox, QLabel, QDialog, QVBoxLayout #,QApplication
