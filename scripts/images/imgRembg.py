...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QCheckBox, QColorDialog, QLabel, QFileDialog, QProgressBar, QMessageBox #,QApplication
...
#|__] |  \ |  | |    |  | | |___ |  | |___    |__| ___] |___ |  \    | | \|  |  |___ |  \ |    |  | |___ |___ 
    ...
    def GUI(self):
        ...
        self.folder_button.setToolTip("Open folder with files you want to remove/replace background")
        ...
        self.check_box.setToolTip("Remove background only")
        ...
        self.color_square.setToolTip("Apply background color")
        ...
        self.random_color_checkbox.setToolTip("Set random background color")
